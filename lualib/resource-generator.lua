...
local next_resource_index = 6 -- Going to start at 6 as there's already 6 entires(0-5).

--[[
if not global.resource_generator then
  global.resource_generator =
  {
...
local resource_generator = {
  resource_autoplace_data = resource_autoplace_data,
  resource_indexes = resource_indexes,
  next_resource_index = next_resource_index,
}
...
local function get_next_resource_index()
...
resource_generator.get_next_resource_index = get_next_resource_index
...
local function setup_resource_autoplace_data(name, params)
...
resource_generator.setup_resource_autoplace_data = setup_resource_autoplace_data
...
local function finalise_resource_autoplace()
...
resource_generator.finalise_resource_autoplace = finalise_resource_autoplace
