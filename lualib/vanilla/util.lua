...
local function compare( tbl1, tbl2 )
  ...
  for k, v in pairs( tbl1 ) do
    if  type(v) == "table" and type(tbl2[k]) == "table" then
      if not compare( v, tbl2[k] )  then return false end
    else
...
util.table.compare = compare
util.copy = util.table.deepcopy

util.distance = function(position1, position2)
...
util.positiontostr = function(pos)
  return string.format("[%g, %g]", pos[1] or pos.x, pos[2] or pos.y)
end

util.formattime = function(ticks)
...
util.color = function(hex)  -- supports 'rrggbb', 'rgb', 'rrggbbaa', 'rgba', 'ww', 'w'
...
util.premul_color = function(color)
...
util.multiply_color = function(c1, n)
  return
  {
...
util.moveposition = function(position, direction, distance)
...
util.oppositedirection = function(direction)
  if not tonumber(direction) then error(direction .. " is not a valid direction") end
  return (direction + 4) % 8
end

util.multiplystripes = function(count, stripes)
  local ret = {}
...
util.by_pixel = function(x,y)
  return {x / 32, y / 32}
end

util.by_pixel_hr = function(x,y)
  return {x / 64, y / 64}
end

util.foreach_sprite_definition = function(table_, fun_)
...
util.add_shift_offset = function(offset_, table_)
  return
...
util.mul_shift = function(shift, scale)
...
util.format_number = function(amount, append_suffix)
  local suffix = ""
...
util.increment = function(t, k, v)
  t[k] = t[k] + (v or 1)
end

util.conditional_return = function(value, data)
...
util.combine_icons = function(icons1, icons2, inputs, default_icon_size)
...
util.technology_icon_constant_damage = function(technology_icon)
  local icons =
  {
    {
...
util.technology_icon_constant_speed = function(technology_icon)
  local icons =
  {
    {
      icon = technology_icon,
...
util.technology_icon_constant_movement_speed = function(technology_icon)
  local icons =
  {
    {
      icon = technology_icon,
...
util.technology_icon_constant_range = function(technology_icon)
  local icons =
  {
    {
      icon = technology_icon,
...
util.technology_icon_constant_equipment = function(technology_icon)
  local icons =
  {
    {
      icon = technology_icon,
...
util.technology_icon_constant_followers = function(technology_icon)
  local icons =
  {
    {
      icon = technology_icon,
...
util.technology_icon_constant_capacity = function(technology_icon)
  local icons =
  {
    {
      icon = technology_icon,
...
util.technology_icon_constant_stack_size = function(technology_icon)
  local icons =
  {
    {
      icon = technology_icon,
...
util.technology_icon_constant_productivity = function(technology_icon)
  local icons =
  {
    {
      icon = technology_icon,
...
util.technology_icon_constant_braking_force = function(technology_icon)
  local icons =
  {
    {
      icon = technology_icon,
...
util.technology_icon_constant_mining = function(technology_icon)
  local icons =
  {
    {
      icon = technology_icon,
...
util.parse_energy = function(energy)
...
util.draw_as_glow = function(layer)
...
util.remove_tile_references = function(data, array_of_tiles_to_remove)
  -- Does not handle:
