...
🇬🇧 [English version](../../en/adr/0001-class-factory.md)
...
- **Contraintes Factorio** : Lua **5.1**, déterminisme multijoueur, et des instances runtime qui sont des **wrappers temporaires** (jamais stockés dans `storage` — voir [wrappers temporaires](../concepts/wrappers-temporaires.md)).
...
- [Factory de classes orientée objet maison (concept)](../concepts/factory-oo.md)
