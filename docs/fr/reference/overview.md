...
🇬🇧 [English version](../../en/reference/overview.md)

Cette page recense **toutes les classes publiques de RitnLib**, avec pour chacune : son fichier source, son mode d'accès, son héritage et une description courte. Pour comprendre comment ces classes s'empilent, voir [Architecture en 4 couches](../concepts/architecture-couches.md).
...
⚠ Les classes runtime produisent des **wrappers temporaires** : jamais dans `storage`. Voir la [règle d'or](../concepts/wrappers-temporaires.md).
