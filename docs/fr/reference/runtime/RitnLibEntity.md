...
🇬🇧 [English version](../../../en/reference/runtime/RitnLibEntity.md)
...
- **Wrapper temporaire** — ne jamais stocker l'instance dans `storage` ; la reconstruire dans chaque handler. Voir [Wrappers temporaires](../../concepts/wrappers-temporaires.md).
...
- [Bugs connus](../../debt/known-bugs.md) · [Wrappers temporaires](../../concepts/wrappers-temporaires.md)
