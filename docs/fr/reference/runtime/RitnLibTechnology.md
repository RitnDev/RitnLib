...
🇬🇧 [English version](../../../en/reference/runtime/RitnLibTechnology.md)
...
- **Wrapper temporaire** — ne jamais stocker l'instance dans `storage`. Voir [Wrappers temporaires](../../concepts/wrappers-temporaires.md).
