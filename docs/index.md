...
- 🧩 [Architecture en 4 couches](concepts/architecture-layers.md) — comment le mod est organisé
- ⚠ [Règle d'or des wrappers temporaires](concepts/temporary-wrappers.md) — à lire **avant** d'utiliser les classes runtime
...
- [ADR-0004 — Stratégie linguistique FR + EN](adr/0004-fr-en-strategy.md)
