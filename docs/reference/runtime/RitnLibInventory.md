...
- **Persistance déléguée** — RitnLib ne possède pas la table de snapshots ; tu fournis la tienne. Voir [Persistance déléguée](../../concepts/delegated-persistence.md).
...
- [Persistance déléguée](../../concepts/delegated-persistence.md) · [Wrappers temporaires](../../concepts/temporary-wrappers.md)
