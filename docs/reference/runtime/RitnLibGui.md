...
- **Wrapper temporaire** — ne jamais stocker l'instance dans `storage` ; la reconstruire dans chaque handler GUI. Voir [Wrappers temporaires](../../concepts/temporary-wrappers.md).
